...
<body>
    <div id="wrap">
        ...
        <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">장비교육 신청 현황 확인</h2>
                    <p class="desc">3D 프린터, 레이저커터, 열전사 프레스 등 장비 교육 신청 확인</br>고려대학교 KU메이커스페이스에서의 장비 교육 신청 현황을 확인해보세요.</p>
                </div>
            </section>
            <ul class="buttons">
			    <li><button onclick="location.href='education/edushow_student3.php'">[학생용] 장비교육 신청 확인</button></li>
			    <li><button onclick="location.href='education/edushow.php'">[관리자용] 장비교육 신청 현황 확인</button></li>
		    </ul>
