        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    ...
                    <p class="desc">내가 원하는 물건을 직접 설계하고 제작해볼 수 있는 공간<br>3D 프린터, 레이저커터, 티셔츠 프린터기, 프로그램 자수기, CNC, 목공실 등 다양한 최신 제작툴을 구비한 곳</p>
                </div>
            </section>
                    ...
                    <ul class="promo-list">
                        ...
                        <li>
                            <a href="education.php">
                                <img src="images/icon2_lasercutter.png" alt="">
                                <h3>장비 교육</h3>
                                <p>장비 교육을 무료로 받아보세요.</p>
                            </a>
                        </li>
                        <li>
                            <a href="reservation.php">
                                <img src="images/icon3_3dprinter_1.png" alt="">
                                <h3>장비 예약</h3>
                                <p>KU메이커스페이스에 있는 장비들은 예약 후 이용 가능합니다.</p>
                            </a>
                        </li>
                        <li>
                            <a href="product.php">
            ...
            <section class="blog-section">
                <div class="container">
                    ...
                    <ul class="blog-list">
                        <li>
                            <a href="education1.php"><img src="images/3dprinter1_3dp310f.png" alt=""></a>
                            <time datetime="2022-05-10">MAY 10, 2022</time>
                            <a href="education1.php"><h3>5월 장비교육 - 3D 프린터</h3></a>
                        </li>
                        <li>
                            <a href="education2.php"><img src="images/laser2_epilog_helix.png" alt=""></a>
                            <time datetime="2022-05-17">MAY 17, 2022</time>
                            <a href="education2.php"><h3>5월 장비교육 - 레이저커터</h3></a>
                        </li>
                        <li>
                            <a href="education3.php"><img src="images/yeoljunsa_hotronixfusionfx.png" alt=""></a>
                            <time datetime="2022-05-24">MAY 24, 2022</time>
                            <a href="education3.php"><h3>5월 장비교육 - 열전사 프레스</h3></a>
                        </li>
                    </ul>
                </div>
            </section>
