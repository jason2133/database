    ...
    <div id="wrap">
        ...
        <section class="content">
            ...
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">열전사 프레스 : 5월 24일 (화)</h2>
                    <p class="desc">열을 이용하여 강하게 재료를 눌러 새로운 물품을 만드는 기계</br>강한 열을 이용하여 나만의 작품을 만들어 보세요.</p>
                </div>
            </section>
            <ul class="buttons">
			    <li><button onclick="location.href='education.php'">목록</button></li>
			    <li><button onclick="location.href='education/eduform3.php'">장비교육 신청하기</button></li>
		    </ul>
