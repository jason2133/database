    ...
    <div id="wrap">
        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">파란색 성</h2>
                    <p class="desc">나만의 성 만들기</br>고려대학교 KU메이커스페이스에서 만든 작품을 구경해보세요.</p>
                </div>
            </section>
            <article class="product1">
                <img src="images/fig6_blue_shinjun.png" alt="">
                <p></br></p>
                <p>파란색 성을 만들어보았습니다.</br>계단을 따라 위로 올라가는 모습이 인상적이네요.</p>
                <p>파란색 성을 어떻게 만들지 가볍게 2D 상으로 디자인한 후,</br>대략적인 모습을 확인하기 위해 3D 상으로도 확인해보았습니다.</p>
                <p>이후 지점토를 이용하여 전체적인 틀을 만들었고,</br>이를 세부적으로 수정해가며 파란색 성을 만들었습니다.</p>
                <p>이제 딥러닝 NeRF 기술을 활용하여 작품의 3D 모델을 확인해볼 차례입니다.</br>하단의 2개 영상을 비교해보세요.</br</br</p>
            </article>
            <article class="product2">
                <p>★ 작품을 360도로 촬영한 동영상</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/W90hC3THoVQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </article>
            <article class="product2">
                <p>★ 딥러닝 NeRF를 활용한 작품의 3D 모델 구현</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/XvSczJ2WAT0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </article>
            <div class ='product4'>
                <p></p>
            </div>
