    ...
    <div id="wrap">
        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">장비예약</h2>
                    <p class="desc">3D 프린터, 레이저커터, 열전사 프레스 등 많은 장비가 있는 이 곳!</br>고려대학교 KU메이커스페이스에서의 장비 예약 현황을 확인해보세요.</p>
                </div>
            </section>
            <ul class="buttons">
			    <!-- <li><button onclick="location.href='education.php'">회원 등록</button></li> -->
			    <li><button onclick="location.href='reservation_form.php'">장비 예약</button></li>
                <li><button onclick="location.href='reservation_show.php'">예약 조회</button></li>
		    </ul>
        </section>
