    ...
    <div id="wrap">
        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">I am GROOT!</h2>
                    <p class="desc">3D 프린터를 활용한 제작</br>고려대학교 KU메이커스페이스에서 만든 작품을 구경해보세요.</p>
                </div>
            </section>
            <article class="product1">
                <img src="images/fig1_groot.png" alt="">
                <p>영화 '어벤져스'에 등장하는 귀여운 캐릭터 GROOT 입니다.</br>항상 'I am GROOT'라고 소리지르곤 하죠.</p>
                <p>Autodesk의 Fusion 360을 활용하여 직접 GROOT 캐릭터를 디자인한 후,</br>obj 형식의 파일로 추출하였습니다.</p>
