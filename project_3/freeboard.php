    ...
    <div id="wrap">
        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">자유 게시물</h2>
                    <p class="desc">자유롭게 게시물을 업로드해보세요.</br>내가 원하는 물건을 직접 설계하고 제작해볼 수 있는 공간</p>
                </div>
            </section>
            <h2></h2>
	<ul class="board_list">
		...
		<li>
			...
			<span class="col2"><a href="freeboard_view.php?num=<?=$num?>"><?=$subject?></a></span>
		...
		<ul class="buttons">
			<li><button onclick="location.href='freeboard.php'">목록</button></li>
