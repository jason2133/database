    ...
    <div id="wrap">
        ...
        <section class="content">
            ...
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">레이저커터 : 5월 17일 (화)</h2>
                    <p class="desc">레이저를 사용하여 재료를 기화시켜 절단면을 만드는 기계</br>레이저로 물체를 마음대로 잘라보세요.</p>
                </div>
            </section>
            <ul class="buttons">
			    <li><button onclick="location.href='education.php'">목록</button></li>
			    <li><button onclick="location.href='freeboard_form.php'">장비교육 신청하기</button></li>
		    </ul>
