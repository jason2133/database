    ...
    <div id="wrap">
        ...
        <section class="content">
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">어몽어스</h2>
                    <p class="desc">3D 프린터를 활용한 제작</br>고려대학교 KU메이커스페이스에서 만든 작품을 구경해보세요.</p>
                </div>
            </section>
            <article class="product1">
                <img src="images/fig5_amongus.png" alt="">
                <p></br></p>
                <p>게임 '어몽어스'에 등장하는 귀여운 캐릭터 어몽어스 입니다.</br>어몽어스 게임 자제가 몹시 유명하죠.</p>
                <p>어몽어스를 어떻게 만들지 가볍게 2D 상으로 디자인한 후,</br>대략적인 모습을 확인하기 위해 3D 상으로도 확인해보았습니다.</p>
                <p>이후 3D 프린터를 활용하여 전체적인 모습을 제작한 후,</br>페인트 등을 칠해가며 어몽어스를 만들었습니다.</p>
                <p>이제 딥러닝 NeRF 기술을 활용하여 작품의 3D 모델을 확인해볼 차례입니다.</br>하단의 2개 영상을 비교해보세요.</br</br</p>
            </article>
            <article class="product2">
                <p>★ 작품을 360도로 촬영한 동영상</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/26K1XX2B5O8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </article>
            <article class="product2">
                <p>★ 딥러닝 NeRF를 활용한 작품의 3D 모델 구현</p>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/W3yGKw1Ha2w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </article>
            <div class ='product4'>
                <p></p>
            </div>
