...
<body> 
    <form name="member" action="reservation_insert.php" method="post">
		<h2>장비 예약 하기</h2>
    	<ul class="join_form">
            <li>
            ...
            <li>
                <span class="col1">예약 장비</span>
                <span class="col2"><input type="int" name="equipment"></span>               
            </li>
            <li>
                <span class="col1">장비 예약 일시</span>
                <span class="col2"><input type="datetime" name="datewhen"></span>               
            </li>                        
        </ul>                       
		<ul class="buttons">
	        <li><button type="button" onclick="check_input()">예약하기</button></li>
            <li><button type="button" onclick="reset_form()">취소하기</button></li>
            <li><button type="button"><a href='reservation.php'>뒤로가기</a></button></li>
        </ul>
    </form>
</body>
</html>