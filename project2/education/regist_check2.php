...
<?php
    ...
    $sql = "select * from reservationtable";
...
<table width='1000' border='1' bordercolor='blue' cellpadding='1'>
	<tr>
        ...
        <td bgcolor='#FFFF00'><B> 이메일 </B></td>
        <td bgcolor='#FFFF00'><B> 휴대전화 </B></td>
        <td bgcolor='#FFFF00'><B> 예약일자 </B></td>
        <td bgcolor='#FFFF00'><B> 예약장비 </B></td>
        <td bgcolor='#FFFF00'><B> 예약 신청한 일자 </B></td> 
	</tr>	
...
<?php
    ...
    echo "장비 예약 학생의 수 : {$row_count} 명";
?>
</br>
<a href='../reservation_show.php'></br></br>뒤로가기</a>
</body>
</html>