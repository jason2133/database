    ...
    <div id="wrap">
        ...
        <section class="content">
            ...
            <section class="display-section">
                <div class="container">
                    <h2 class="sec-tit">3D 프린터 : 5월 10일 (화)</h2>
                    <p class="desc">3차원의 물체를 적층 방식으로 쌓아 올려 만들어주는 기계</br>내가 원하는 물건을 자유롭게 3D로 만들어보세요.</p>
                </div>
            </section>
            <ul class="buttons">
			    <li><button onclick="location.href='education.php'">목록</button></li>
			    <li><button onclick="location.href='education/eduform.php'">장비교육 신청하기</button></li>
		    </ul>
